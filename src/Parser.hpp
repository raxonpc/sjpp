...
namespace sjpp {
    ...
    protected:
        ...
        static std::pair<std::string, Parser::ParseCode> get_tag_content(const std::string& line) noexcept;
        static std::pair<std::vector<std::string>, Parser::ParseCode> parse_meanings(const std::string& content) noexcept;
        static void remove_substr(std::string& line, const std::string& substr) noexcept;
